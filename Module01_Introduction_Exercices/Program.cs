...
namespace Module01_Introduction_Exercices
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                container.RegisterType<IDepotImportationMunicipalites, DepotImportationMunicipaliteJSON>(TypeLifetime.Singleton, new Unity.Injection.InjectionConstructor(new object[] { fichierJson }))
